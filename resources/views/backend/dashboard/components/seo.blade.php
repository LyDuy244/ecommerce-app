<div class="ibox">
    ...
    <div class="ibox-content">
        <div class="seo-container">
          <div class="meta-title">{{ old('meta_title', ($model->meta_title)??"") ?? __('message.seoTitle') }}</div>
          <div class="canonical">{{ (old('canonical', ($model->canonical)??"")) ? env("APP_URL").old('canonical', ($model->canonical)??"").'.html' : __('message.seoCanonical') }}</div>
          <div class="meta-description">
            {{ old('meta_description', ($model->meta_description)??"") ??  __('message.seoDescription') }}
          </div>
        </div>
