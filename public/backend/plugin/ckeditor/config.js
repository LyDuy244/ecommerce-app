...
CKEDITOR.editorConfig = function (config) {
	...
	config.filebrowserBrowseUrl = BASE_URL + 'backend/plugin/ckfinder.html';
	config.filebrowserImageBrowseUrl = BASE_URL + 'backend/plugin/ckfinder/ckfinder.html';
	config.filebrowserFlashBrowseUrl = BASE_URL + 'backend/plugin/ckfinder/ckfinder.html';
